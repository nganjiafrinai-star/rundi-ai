...
const WeatherCard = () => {
    ...
    if (loading && !weather) {
        return (
            <div className="h-full min-h-[220px] bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 rounded-2xl p-6 text-black shadow-lg overflow-hidden relative flex items-center justify-center">
                <div className="flex flex-col items-center gap-4 relative z-10">
                    <RefreshCw className="w-8 h-8 animate-spin text-black" />
                    <p className="text-sm font-medium text-black">Ikirere kiriko kirakurwa...</p>
                </div>
    ...
    return (
        <div className="h-full bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 rounded-2xl p-6 text-black shadow-lg overflow-hidden relative min-h-[220px] transition-all duration-500">
            <div className="relative z-10 flex flex-col h-full">
                ...
                <form onSubmit={handleSearch} className="mb-4 relative group">
                    <input
                        ...
                        className="w-full bg-white/10 border border-white/20 hover:border-white/40 focus:border-white/60 rounded-full py-1.5 pl-9 pr-4 text-xs text-black placeholder:text-gray-600 focus:outline-none focus:bg-white/15 transition-all"
                    />
                    <Search className="w-4 h-4 text-black absolute left-3 top-1/2 -translate-y-1/2 group-focus-within:text-black transition-colors" />
                    {loading && (
                ...
                {error && (
                    <div className="flex-1 flex flex-col items-center justify-center py-2 text-center">
                        <p className="text-xs mb-4 text-black max-w-[200px] leading-relaxed italic">{error}</p>
                        <button
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <div className="flex items-center gap-1.5 text-black text-xs font-semibold mt-0.5">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-black text-[10px] font-bold uppercase tracking-widest mt-1">{weather.condition}</p>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-2 gap-x-6 gap-y-2 flex-1 border-l border-white/10 pl-4">
                                <div className="space-y-0.5">
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span className="text-[10px] font-bold text-black uppercase tracking-tighter">Humidity</span>
                                    </div>
                                ...
                                <div className="space-y-0.5">
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span className="text-[10px] font-bold text-black uppercase tracking-tighter">Wind</span>
                                    </div>
